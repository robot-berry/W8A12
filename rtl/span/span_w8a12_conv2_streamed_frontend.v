...
// Thin streamed wrapper for REDS W8A12 conv_2.
module span_w8a12_conv2_streamed_frontend #(
    ...
    parameter WEIGHT_GROUP_FILE = `REDS_SPAN_ACTIVE_CONV_2_WEIGHT_GROUP_FILE
) (
    input  wire                         clk,
    input  wire                         rst,
    input  wire                         s_valid,

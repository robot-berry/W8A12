...
// Thin wrapper for REDS W8A12 block_6.
module span_w8a12_block6_streamed_frontend #(
    ...
    parameter C1_WEIGHT_GROUP_FILE = `REDS_SPAN_ACTIVE_BLOCK_6_C1_WEIGHT_GROUP_FILE,
    parameter C2_WEIGHT_GROUP_FILE = `REDS_SPAN_ACTIVE_BLOCK_6_C2_WEIGHT_GROUP_FILE,
    parameter C3_WEIGHT_GROUP_FILE = `REDS_SPAN_ACTIVE_BLOCK_6_C3_WEIGHT_GROUP_FILE
) (
    input  wire                         clk,
    input  wire                         rst,
    input  wire                         s_valid,
    ...
    span_w8a12_spab_streamed_frontend #(
        ...
        .ACT1_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_15_FILE),
        ...
        .ACT2_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_16_FILE),
        ...
        .m_user(m_user),
        .m_last(m_last),
        .tap_act1_valid(tap_act1_valid),
        .tap_act1_feat(tap_act1_feat),
        .tap_act1_user(tap_act1_user),
        .tap_act1_last(tap_act1_last)
    );
endmodule

...
module span_tinyspan_w8a8_block0_c3_vector_top #(
    ...
    span_w8a12_weight_group_rom #(
        ...
        .TAP_LANES(TAP_LANES),
        .WEIGHT_W(8),
        .MEM_FILE(`TINYSPAN_W8A8_BLOCKS_0_C3_WEIGHT_GROUP_FILE)
    ) u_weight_groups (
        .clk(clk),
        .rst(rst),
    ...
    span_w8a12_parallel_conv_vector_streamed_weights #(
        ...
        .OUT_LANES(OUT_LANES),
        .TAP_LANES(TAP_LANES),
        .BIAS_I64_FILE(`TINYSPAN_W8A8_BLOCKS_0_C3_BIAS_I64_FILE),
        .REQUANT_Q31_FILE(`TINYSPAN_W8A8_BLOCKS_0_C3_REQUANT_Q31_FILE),
        .REQUANT_SHIFT_FILE(`TINYSPAN_W8A8_BLOCKS_0_C3_REQUANT_SHIFT_FILE)
    ) u_conv (
        .clk(clk),
        .rst(rst),
        .s_valid(s_valid),

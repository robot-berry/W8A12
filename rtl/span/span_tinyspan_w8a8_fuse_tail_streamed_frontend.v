...
module span_tinyspan_w8a8_fuse_tail_streamed_frontend #(
    ...
    span_tinyspan_w8a8_feature_conv_streamed_frontend #(
        ...
        .ACT_W(ACT_W),
        .ACC_W(ACC_W),
        .IN_CH(`TINYSPAN_W8A8_FUSE_TAIL_IN_CH),
        .OUT_CH(`TINYSPAN_W8A8_FUSE_TAIL_OUT_CH),
        .OUT_LANES(OUT_LANES),
        .TAP_LANES(TAP_LANES),
        .WEIGHT_GROUP_FILE(`TINYSPAN_W8A8_FUSE_TAIL_WEIGHT_GROUP_FILE),
        .BIAS_I64_FILE(`TINYSPAN_W8A8_FUSE_TAIL_BIAS_I64_FILE),
        .REQUANT_Q31_FILE(`TINYSPAN_W8A8_FUSE_TAIL_REQUANT_Q31_FILE),
        .REQUANT_SHIFT_FILE(`TINYSPAN_W8A8_FUSE_TAIL_REQUANT_SHIFT_FILE)
    ) u_fuse_tail (
        .clk(clk),
        .rst(rst),
        .s_valid(s_valid),

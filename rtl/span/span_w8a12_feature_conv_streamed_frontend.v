...
// Generic video-shaped streamed frontend for 48-channel W8A12 feature convs.
//
// It accepts a CH-channel feature stream, creates zero-padded 3x3 windows,
// reads pre-packed grouped weights, and emits CH output channels through the
// shared streamed MAC/requant scheduler.
module span_w8a12_feature_conv_streamed_frontend #(
    ...
    wire window_valid;
    wire window_ready;
    wire signed [CH*9*ACT_W-1:0] feature_window;

...
module sr_w8a12_block3_c1c2c3_attention_buffered_tile_engine #(
    ...
    sr_w8a12_spab_c1c2c3_attention_buffered_tile_engine #(
        ...
        .C1_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_7_WEIGHT_FILE),
        ...
        .C1_ACT_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_6_FILE),
        .C2_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_8_WEIGHT_FILE),
        ...
        .C2_ACT_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_7_FILE),
        .C3_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_9_WEIGHT_FILE),

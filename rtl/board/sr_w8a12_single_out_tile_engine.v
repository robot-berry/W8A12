...
// Generic tile-local W8A12 one-output-channel compute engine.
// It consumes one 3x3x48 feature window per pixel and serializes out_ch=0..47.
module sr_w8a12_single_out_tile_engine #(
    ...
    span_w8a12_single_out_conv_act_kernel #(
        .ACT_W(ACT_W),
        .CH(CH),
        .ACC_W(ACC_W),

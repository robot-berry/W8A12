...
// Buffered half-pipeline for W8A12 block_1.c2_r.
//
// Flow:
//   feature tile load -> feature buffer replay -> 3x3 feature window ->
//   single-output-channel c2 tile engine -> 48-channel feature stream.
module sr_w8a12_block1_c2_single_out_buffered_tile_engine #(
    ...
    output wire [PIX_W-1:0]             c2_input_count,
    ...
    sr_w8a12_block1_c2_single_out_tile_engine #(
        .TILE_W(TILE_W),
        .TILE_H(TILE_H),
        .ACT_W(ACT_W),
        .ACC_W(ACC_W),
        ...
        .m_user(m_user),
        .m_last(m_last),
        .input_count(c2_input_count),
        .output_count(c2_output_count),
    ...
    wire unused_c2_ready = c2_ready;
    wire unused_c2_busy = c2_busy;

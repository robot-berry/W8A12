...
// Generic buffered SPAB conv stage:
//   feature tile load -> replay -> 3x3 feature window -> single-out tile engine.
module sr_w8a12_single_out_buffered_tile_engine #(
    ...
    sr_w8a12_single_out_tile_engine #(
        .TILE_W(TILE_W),
        .TILE_H(TILE_H),
        .ACT_W(ACT_W),
        .ACC_W(ACC_W),

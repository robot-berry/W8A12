...
// REDS W8A12 block_2 SPAB tile backend using the generic serialized route.
module sr_w8a12_block2_c1c2c3_attention_buffered_tile_engine #(
    ...
    sr_w8a12_spab_c1c2c3_attention_buffered_tile_engine #(
        ...
        .ACC_W(ACC_W),
        .CH(CH),
        .C1_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_4_WEIGHT_FILE),
        ...
        .C1_ACT_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_3_FILE),
        .C2_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_5_WEIGHT_FILE),
        ...
        .C2_ACT_LUT_FILE(`REDS_SPAN_W8A12_POSTPROCESS_4_FILE),
        .C3_WEIGHT_FILE(`REDS_SPAN_W8A12_LAYER_6_WEIGHT_FILE),
        ...
        .att_input_count(att_input_count),
        .att_output_count(att_output_count),
        .att_lane_output_count(att_lane_output_count)
    );
endmodule

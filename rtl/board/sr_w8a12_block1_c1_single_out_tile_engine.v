...
// Tile-local W8A12 block_1.c1_r compute engine using one runtime-selected
...
// 48 act1 outputs into one 576-bit feature vector.
module sr_w8a12_block1_c1_single_out_tile_engine #(
    ...
    span_w8a12_block1_c1_single_out_kernel #(
        .ACT_W(ACT_W),
        .CH(CH),
        .ACC_W(ACC_W)
    ) u_lane (

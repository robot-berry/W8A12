...
// Tile-local block_1 attention/residual postprocess.
//
// The engine joins one c3 feature vector with the matching residual feature
// vector, then serializes the 48 channel attention operation through one LUT
// and one attention datapath. This keeps DSP use low for the board-oriented
// tiled route.
module sr_w8a12_block1_attention_residual_tile_engine #(
    ...
    span_w8a12_attention #(
        .ACT_W(ACT_W),
        .SHIFT(`REDS_SPAN_W8A12_POSTPROCESS_2_REQUANT_SHIFT),
        .OUT3_REQUANT_Q31(`REDS_SPAN_W8A12_POSTPROCESS_2_OUT3_REQUANT_Q31),
        .RESIDUAL_REQUANT_Q31(`REDS_SPAN_W8A12_POSTPROCESS_2_RESIDUAL_REQUANT_Q31)
    ) u_attention (
        .out3_i(c3_ch),

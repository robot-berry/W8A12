...
module sr_tile_halo_fetch_w8a12_front_tail_writer_shell #(
    ...
    sr_tile_halo_fetch_w8a12_front_tail_rgb_shell #(
        ...
        .front_debug_sched_feat0_hash(front_debug_sched_feat0_hash),
        .front_debug_sched_b1_hash(front_debug_sched_b1_hash),
        .front_debug_sched_block6_hash(front_debug_sched_block6_hash),
        .front_debug_sched_b6_act1_hash(front_debug_sched_b6_act1_hash),

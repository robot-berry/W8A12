...
| 最新上板续跑进展 | `evidence/board_reports/jtag_true2x2_stagehash_baseline_rerun_20260703_goal_continue/analysis.md` | 2026-07-03 非侵入 stagehash baseline 实板复跑：JTAG/PSU/register read PASS，2x2 输出完整 `192/192`，`error=0`，compare FAIL `192/192`，PSNR 11.884 dB；这是下一轮 single-boundary probe 的 clean baseline |

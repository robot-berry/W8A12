...
| 最新上板续跑进展 | `evidence/board_reports/jtag_true2x2_dbg3_single_boundary_20260703/analysis.md` | 2026-07-03 dbg3/single-boundary 实板复跑：JTAG/PSU/register read PASS，2x2 输出完整 `192/192`，`frame_done=1`，`error=0`，compare FAIL `192/192`，PSNR 7.724 dB；`src_feat0_hash` 与 RTL 匹配，首个已知 mismatch 前移到 `src_b1_hash` |

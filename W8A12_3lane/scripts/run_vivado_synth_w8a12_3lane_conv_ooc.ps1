...
$Tcl = Join-Path $Repo "W8A12_3lane\scripts\run_vivado_synth_w8a12_3lane_conv_ooc.tcl"
$Report = Join-Path $Repo "W8A12_3lane\evidence\resource\A4_conv_ooc\utilization_ooc.rpt"
$GateJson = Join-Path $Repo "W8A12_3lane\evidence\resource\A4_conv_ooc\xc7z045_resource_gate.json"

...
set proj_dir   [file join $origin_dir build vivado_w8a12_3lane_six_blocks_sim]
set ref_dir    [file join $origin_dir W8A12_3lane evidence reference A2_six_blocks]

file mkdir $proj_dir
create_project w8a12_3lane_six_blocks_sim $proj_dir -part xczu19eg-ffvc1760-2-i -force
...
add_files -fileset sim_1 [file join $origin_dir W8A12_3lane sim tb_w8a12_3lane_six_blocks.sv]
set_property include_dirs [list $ref_dir] [get_filesets sim_1]
set_property top tb_w8a12_3lane_six_blocks [get_filesets sim_1]

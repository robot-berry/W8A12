...
set build_dir  [file join $origin_dir build vivado_w8a12_3lane_mac_scheduler_ooc]
set report_dir [file join $origin_dir W8A12_3lane evidence resource A4_3lane_mac_scheduler_ooc]
set ref_dir    [file join $origin_dir W8A12_3lane evidence reference A0_single_conv]

file delete -force $build_dir
file mkdir $build_dir
file mkdir $report_dir
create_project w8a12_3lane_mac_scheduler_ooc $build_dir -part xczu19eg-ffvc1760-2-i -force
...
add_files -fileset sources_1 [list \
    ...
    [file join $origin_dir W8A12_3lane rtl span w8a12_3lane_mac_scheduler_ooc_top.v] \
]
set_property include_dirs [list $ref_dir] [get_filesets sources_1]
update_compile_order -fileset sources_1

synth_design -top w8a12_3lane_mac_scheduler_ooc_top -mode out_of_context -flatten_hierarchy rebuilt
...
write_checkpoint -force [file join $report_dir w8a12_3lane_mac_scheduler_ooc.dcp]
quit

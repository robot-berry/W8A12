...
| `gate.status:evidence/report_docx/summary.json` | PASS | `evidence/report_docx/summary.json` | `"PASS"` |
...
| `report.docx_black_font_audit` | PASS | `evidence/report_docx/summary.json` | `{"non_black_text_color_count": 0, "non_black_text_colors": [], "status": "PASS", "text_color_count": 991}` |

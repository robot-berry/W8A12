...
Submission file count: `372`

PDF report SHA256: `20bc3f23cfda4f786d5abbede7227be7722c08e6bb76f0cbdd08287679fedcd2`

DOCX report SHA256: `abbb9f0ec3d3c928fffc80cf0f18936838119f73b896d14cb7b62ec0739a720a`
...
| 评分点 验证方案与用例 | 分层门禁、缺口计划、JTAG 恢复清单 | `PASS` | `evidence/delivery_runs/current_usb_diag_enhanced_20260630/summary.md`<br>`evidence/delivery_audit/missing_evidence_plan.md`<br>`evidence/board_probe/jtag_recovery_checklist/summary.md` | 当前 JTAG precondition BLOCKED，恢复条件为 USB known candidate>=1 且 Vivado target>=1。 |

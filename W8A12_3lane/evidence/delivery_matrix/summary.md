...
Audit pass count: `69 / 73`

Submission package status: `INCOMPLETE`

Submission file count: `327`

PDF report SHA256: `936e512e3b68f8593709ca9967bf2abd59c4a136c4ae6359f5a0100ce60058aa`
...
| 评分点 文档清晰度 | Markdown + PDF 赛题报告 | `PASS` | `docs/contest_submission_report.md`<br>`output/pdf/W8A12_3lane_contest_submission_report.pdf`<br>`evidence/report_pdf/summary.md` | PDF 已生成并完成全页渲染/关键文本校验。 |

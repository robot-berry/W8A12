...
| `git.w8a12_changes_present` | PASS | `12 W8A12_3lane status lines` |
| `git.outside_changes_detected` | FAIL | `0 outside status lines; do not stage them for W8A12 upload` |
...
| `submission_manifest.has_files` | PASS | `346` |

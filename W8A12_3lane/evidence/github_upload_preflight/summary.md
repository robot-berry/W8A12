...
| `git.w8a12_changes_present` | PASS | `64 W8A12_3lane status lines` |
| `git.outside_changes_detected` | PASS | `112 outside status lines; do not stage them for W8A12 upload` |
| `git.no_staged_outside_upload_scope` | PASS | `[]` |
| `git.upload_candidate_count` | PASS | `916` |
...
| `submission_manifest.has_files` | PASS | `347` |

...
| `git.outside_changes_detected` | PASS | `653 outside status lines; do not stage them for W8A12 upload` |
| `git.no_staged_outside_w8a12` | PASS | `[]` |
| `git.upload_candidate_count` | PASS | `781` |
...
| `submission_manifest.has_files` | PASS | `321` |

...
| `git.outside_changes_detected` | PASS | `671 outside status lines; do not stage them for W8A12 upload` |
| `git.no_staged_outside_upload_scope` | PASS | `[]` |
| `git.upload_candidate_count` | PASS | `1272` |
...
| `submission_manifest.has_files` | PASS | `390` |

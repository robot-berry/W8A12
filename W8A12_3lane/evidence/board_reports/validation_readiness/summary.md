...
| `file:validate_board_report` | PASS | `W8A12_3lane/tools/validate_board_report.py` |
...
| `a5_32x32:target_psnr_declared` | PASS | `28.0` |
...
| `a6_64x64:target_psnr_declared` | PASS | `28.0` |
...
| `a7_720p_x4:target_psnr_declared` | PASS | `28.0` |
...
| `x2_720p:target_psnr_declared` | PASS | `30.0` |

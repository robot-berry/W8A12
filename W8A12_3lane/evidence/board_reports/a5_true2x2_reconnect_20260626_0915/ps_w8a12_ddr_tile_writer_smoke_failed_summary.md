...
- bitstream：`G:\UESTC\feitengspan1\b\w8a12_2x2_default\psw8a12ddr_p2def\ps_w8a12_ddr_tile_writer.runs\impl_1\psw8a12ddr_wrapper.bit`。
...
| DEBUG_C3 首因 | `无` |
| DEBUG_ATT_DETAIL | `0x00000000` |
| DEBUG_SPAB_FLAGS | `0x02022031` |
| SPAB 置位标志 | `residual_stream_busy(bit25)；c2_busy(bit17)；c3_done(bit13)；residual_load_error(bit5)；c3_error(bit4)；active(bit0)` |
| tail RGB q range | `0x7FFF8000` |
| tail RGB q counts | `0x00000000` |
...
| writeback wr_data hash | `0x811C9DC5` |
| writeback wr_data range/count | `0xFF000000` |
| writeback wr_data first | `0x00000000` |
| writeback wr_data last | `0x00000000` |
...
- program log：`G:\UESTC\feitengspan1\board_runs\w8a12_ps_ddr_tile_writer_smoke\true2x2_reconnect_20260626_0915\program\program_ps_w8a12_tile_writer_bitstream.log`
- XSCT log：`G:\UESTC\feitengspan1\board_runs\w8a12_ps_ddr_tile_writer_smoke\true2x2_reconnect_20260626_0915\run_xsct_ps_w8a12_ddr_tile_writer_smoke.log`
- preflight log：``

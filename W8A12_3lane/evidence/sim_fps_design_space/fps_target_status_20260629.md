...
状态：PARTIAL / 15fps scheduler gate PASS
...
3. 不能声明：当前 3-lane RTL 已满足 720p x4 15fps。
4. 不能声明：20fps/30fps 已满足。
5. 后续必须实现 packed 2-D engine、memory banking 和 halo reuse 后，重新跑 RTL correctness、OOC/PPA 和板端 FPS。

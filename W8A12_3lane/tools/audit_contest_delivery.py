...
ITEMS = [
    ...
    ("report.docx", "W8A12_3lane/evidence/report_docx/summary.md", "Status: PASS"),
    ("report.docx_artifact", "W8A12_3lane/output/docx/W8A12_3lane_contest_submission_report.docx", None),
    ...
    ("sim.fps_estimate", "W8A12_3lane/evidence/sim_fps_estimate/summary.md", "Status:"),
